...
#define LCD_ENABLE()	GPIO_SetBits(2,2)	 //Port P2.0 = 1
#define LCD_DISABLE()	GPIO_ResetBits(2,2)	 //Port P2.0 = 0
#define LCD_RWON()	 	GPIO_SetBits(2,1)	 //Port P2.1 = 1
#define LCD_RWOFF()	 	GPIO_ResetBits(2,1)	 //Port P2.1 = 0
#define LCD_RSON()	 	GPIO_SetBits(2,0) //Port P2.2 = 1
#define LCD_RSOFF()	 	GPIO_ResetBits(2,0) //Port P2.2 = 0
//
