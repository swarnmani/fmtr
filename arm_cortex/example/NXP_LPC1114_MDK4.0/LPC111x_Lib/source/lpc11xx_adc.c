 ...
 * @param[in]	mod, Analog/Digital mode, it can be
 *               -ADMODE_Analog  : Digital functional mode
 *               -ADMODE_Digital : Analog input mode
 *
 * @return		None
 *********************************************************************/
void IOCON_ADCPinsInit(uint8_t channel, ADMODE_Typedef mod)
{    
    CHECK_PARAM(PARAM_ADC_CHANNEL_SELECTION(Channel)); 
