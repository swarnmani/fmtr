/****************************************************************************
 *   $Id:: uart.c 1782 2012-07-04 12:36:29Z NXP31103                        $
...
{
#if 1  
  LPC_IOCON->TRST_PIO0_9 &= ~0x07;   /* UART I/O config */
  LPC_IOCON->TRST_PIO0_9 |= 0x05;    /* UART CTS */
#ifdef __SWD_DISABLED
  LPC_IOCON->SWDIO_PIO0_10 &= ~0x07;    /* UART I/O config */
  LPC_IOCON->SWDIO_PIO0_10 |= 0x05;     /* UART RTS */
#endif
  LPC_IOCON->PIO0_28 &= ~0x07;    /* UART I/O config */
  LPC_IOCON->PIO0_28 |= 0x01;     /* UART DTR */ 
  LPC_IOCON->PIO0_29 &= ~0x07;    /* UART I/O config */
  LPC_IOCON->PIO0_29 |= 0x01;     /* UART DSR */
  LPC_IOCON->PIO1_9 &= ~0x07;     /* UART I/O config */
  LPC_IOCON->PIO1_9 |= 0x01;      /* UART DCD */
  LPC_IOCON->PIO0_30 &= ~0x07;    /* UART I/O config */
  LPC_IOCON->PIO0_30 |= 0x01;     /* UART RI */
#endif

#if 0
  LPC_IOCON->PIO0_21 &= ~0x07;    /* UART I/O config */
  LPC_IOCON->PIO0_21 |= 0x01;     /* UART CTS */
  LPC_IOCON->PIO0_23 &= ~0x07;    /* UART I/O config */
  LPC_IOCON->PIO0_23 |= 0x01;     /* UART RTS */
  LPC_IOCON->PIO1_1  &= ~0x07;    /* UART I/O config */
  LPC_IOCON->PIO1_1  |= 0x01;     /* UART DTR */
  LPC_IOCON->PIO1_2  &= ~0x07;    /* UART I/O config */
  LPC_IOCON->PIO1_2  |= 0x01;     /* UART DSR */
  LPC_IOCON->PIO1_0  &= ~0x07;    /* UART I/O config */
  LPC_IOCON->PIO1_0  |= 0x01;     /* UART DCD */
  LPC_IOCON->PIO0_31 &= ~0x07;    /* UART I/O config */
  LPC_IOCON->PIO0_31 |= 0x01;     /* UART RI */
#endif

#if 0
  LPC_IOCON->PIO1_7  &= ~0x07;    /* UART I/O config */
  LPC_IOCON->PIO1_7  |= 0x01;     /* UART CTS */
  LPC_IOCON->PIO1_6  &= ~0x07;    /* UART I/O config */
  LPC_IOCON->PIO1_6  |= 0x01;     /* UART RTS */
  LPC_IOCON->PIO1_1  &= ~0x07;    /* UART I/O config */
  LPC_IOCON->PIO1_1  |= 0x01;     /* UART DTR */
  LPC_IOCON->PIO1_2  &= ~0x07;    /* UART I/O config */
  LPC_IOCON->PIO1_2  |= 0x01;     /* UART DSR */
  LPC_IOCON->PIO1_0  &= ~0x07;    /* UART I/O config */
  LPC_IOCON->PIO1_0  |= 0x01;     /* UART DCD */
  LPC_IOCON->PIO1_3  &= ~0x07;    /* UART I/O config */
  LPC_IOCON->PIO1_3  |= 0x01;     /* UART RI */
#endif
...
void UARTInit(uint32_t baudrate)
{
  ...
  LPC_IOCON->PIO0_1  |= 0x01;     /* UART RXD */
  LPC_IOCON->PIO0_26 &= ~0x07;	
  LPC_IOCON->PIO0_26 |= 0x01;     /* UART TXD */
#endif
#if 0
  LPC_IOCON->PIO1_4  &= ~0x07;    /*  UART I/O config */
  LPC_IOCON->PIO1_4  |= 0x01;     /* UART RXD */
  LPC_IOCON->PIO1_5  &= ~0x07;	
  LPC_IOCON->PIO1_5  |= 0x01;     /* UART TXD */
#endif
#if 1
  LPC_IOCON->PIO0_12 &= ~0x07;    /*  UART I/O config */
  LPC_IOCON->PIO0_12 |= 0x01;     /* UART RXD */
  LPC_IOCON->PIO0_13 &= ~0x07;	
  LPC_IOCON->PIO0_13 |= 0x01;     /* UART TXD */
#endif
#if 0
  LPC_IOCON->PIO1_8  &= ~0x07;    /*  UART I/O config */
  LPC_IOCON->PIO1_8  |= 0x01;     /* UART RXD */
  LPC_IOCON->PIO0_15 &= ~0x07;	
  LPC_IOCON->PIO0_15 |= 0x01;     /* UART TXD */
#endif
...
uint8_t get_key( void )
{
  ...
  if ( (dummy>='A') && (dummy<='Z') )
  {
	/* convert capital to non-capital character, A->a, B->b, C->c. */ 
  	dummy+=('a'-'A');
  }    
  /* echo */
  LPC_USART->THR = dummy;
